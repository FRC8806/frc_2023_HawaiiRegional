...
public class TurnToLowNode extends CommandBase {
  private final Arm m_arm;
  private final Catcher m_catcher;
  /** Creates a new TurnOnHighState. */
  public TurnToLowNode(Arm arm, Catcher catcher) {
    m_catcher = catcher;
    m_arm = arm;
  ...
  @Override
  public void execute() {
    double elevatorSpeed = (Constants.NodeConstants.N_LOW_CONE_NODE[0] - m_arm.getElavatorPosition())/50000;
    double armSpeed = (Constants.NodeConstants.N_LOW_CONE_NODE[1] - m_arm.getArmPosition())/50000;
    double neckSpeed = (Constants.NodeConstants.N_LOW_CONE_NODE[2] - m_catcher.getNeckAngle())/30000;
