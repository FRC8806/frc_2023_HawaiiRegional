...
public class TurnToHighNode extends CommandBase {
  private final Arm m_arm;
  private final Catcher m_catcher;
  /** Creates a new TurnOnHighState. */
  public TurnToHighNode(Arm arm, Catcher catcher) {
    m_catcher = catcher;
    m_arm = arm;
  ...
  public void execute() {
    ...
    double armSpeed = (Constants.NodeConstants.N_HIGH_CONE_NODE[1] - m_arm.getArmPosition())/50000;
